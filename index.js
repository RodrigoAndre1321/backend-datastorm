...
/*
app.listen(PORT, () => {
    console.log(`Servidor corriendo en https://app-38bd8802-6852-491d-a0f9-794881613c9b.cleverapps.io:3306`);
});*/
...
app.get("/buscar", (req, res) => {
  ...
  if (!keyword) return res.status(400).json({ error: "Falta palabra clave" });
  ...
  `;
  const param = `%${keyword}%`;
  db.query(query, [param, param, param], (err, results) => {
    if (err) {
      console.error(err);
